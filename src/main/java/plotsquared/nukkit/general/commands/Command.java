package com.plotsquared.nukkit.general.commands;
...
public abstract class Command {
    ...
    private com.plotsquared.general.commands.Argument[] arguments;
    ...
    public Command(Command parent, boolean isStatic) {
        this.parent = parent;
        this.isStatic = isStatic;
        Annotation cdAnnotation = getClass().getAnnotation(com.plotsquared.general.commands.CommandDeclaration.class);
        if (cdAnnotation != null) {
            com.plotsquared.general.commands.CommandDeclaration declaration = (com.plotsquared.general.commands.CommandDeclaration) cdAnnotation;
            init(declaration);
        }
        for (final Method method : getClass().getDeclaredMethods()) {
            if (method.isAnnotationPresent(com.plotsquared.general.commands.CommandDeclaration.class)) {
                ...
                if (types.length == 5 && types[0] == Command.class && types[1] == PlotPlayer.class && types[2] == String[].class
                    ...
                    tmp.init(method.getAnnotation(com.plotsquared.general.commands.CommandDeclaration.class));
                }
            }
        }
    }
    ...
    public com.plotsquared.general.commands.Argument[] getRequiredArguments() {
        return this.arguments;
    }

    public void setRequiredArguments(com.plotsquared.general.commands.Argument[] arguments) {
        this.arguments = arguments;
    }

    public void init(com.plotsquared.general.commands.CommandDeclaration declaration) {
    ...
    public boolean checkArgs(PlotPlayer player, String[] args) {
        com.plotsquared.general.commands.Argument<?>[] reqArgs = getRequiredArguments();
